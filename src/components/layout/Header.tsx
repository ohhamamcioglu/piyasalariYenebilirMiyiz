...
import { TrendingUp, BarChart3, Menu, X, Shield, Star, BookOpen } from 'lucide-react';
      ...
      <div className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <nav className="hidden md:flex items-center gap-1">
            ...
            <Link href="/egitim" className="px-4 py-2 text-sm font-medium text-slate-300 hover:text-white rounded-lg hover:bg-white/5 transition-all flex items-center gap-2">
        ...
        {menuOpen && (
          <nav className="md:hidden pb-4 pt-2 border-t border-[#2a3050]/50 animate-fade-in">
            ...
            <Link href="/egitim" onClick={() => setMenuOpen(false)} className="block px-4 py-3 text-sm font-medium text-slate-300 hover:text-white hover:bg-white/5 rounded-lg">
              📚 Akademi
            </Link>
